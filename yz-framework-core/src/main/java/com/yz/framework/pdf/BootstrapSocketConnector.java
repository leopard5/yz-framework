...
public class BootstrapSocketConnector extends BootstrapConnector {
     ...
     */
    private BootstrapSocketConnector(String oooExecFolder) {
     ...
     */
    static XComponentContext bootstrap(String oooExecFolder) throws BootstrapException {
     ...
     * @return The component context
     */
    public static XComponentContext bootstrap(String oooExecFolder, String host, int port) throws BootstrapException {
     ...
     * @return The component context
     */
    private XComponentContext connect(String host, int port) throws BootstrapException {
